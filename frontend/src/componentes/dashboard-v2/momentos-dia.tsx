...
export function MomentosDia({ momentos }: MomentosDiaProps) {
  ...
  return (
    <div className="flex h-full flex-col justify-center divide-y divide-white/[0.06] rounded-[20px] bg-white/[0.04]">
      {momentosOrdenados.map((momento) => (
        <div key={momento.bloque} className="flex items-center gap-3 px-4 py-4">
