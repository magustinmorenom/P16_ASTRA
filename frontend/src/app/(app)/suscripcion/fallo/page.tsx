    ...
    <section className="relative min-h-full overflow-hidden bg-[#16011B] px-4 py-10 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-xl">
        <div className="rounded-[24px] border border-white/[0.08] bg-[radial-gradient(circle_at_top_left,rgba(179,136,255,0.18),transparent_30%),linear-gradient(135deg,rgba(45,27,105,0.96),rgba(22,1,27,0.98))] p-6 text-center shadow-[0_24px_70px_rgba(8,2,22,0.38)]">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-[20px] border border-rose-400/18 bg-rose-500/[0.12]">
            <Icono nombre="x" tamaño={28} className="text-rose-200" />
          </div>
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-white/62">
            No pudimos procesarlo. Revisá el medio de pago e intentá nuevamente.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link href="/suscripcion">
              <Boton variante="primario" tamaño="lg" icono={<Icono nombre="cohete" tamaño={18} />} className="rounded-full bg-[#7C4DFF] text-white hover:bg-[#8F66FF]">
                Reintentar
              </Boton>
            </Link>
            <Link href="/dashboard">
